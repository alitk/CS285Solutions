...
class RL_Trainer(object):
    ...
    def collect_training_trajectories(
        ...
        :return:
            ...
            envsteps_this_batch: the sum over the numbers of environment steps in paths. Ali: it shows how many total time step is in this batch.
    ...
    def do_relabel_with_expert(self, expert_policy, paths):
        ...
        for i, path in enumerate(paths):
            ...
            paths[i]["action"] = np.array(expert_policy.get_action(observation), dtype = np.float32)
